  ...
  def new
    ...
    respond_to do |format|
      if @studio_event.save
        format.html { redirect_to session.delete(:return_to), :notice => 'Studio note was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @studio_event.update_attributes(params[:studio_event])
        format.html { redirect_to session.delete(:return_to), :notice => 'Studio note was successfully updated.' }
    ...
    respond_to do |format|
      format.html { redirect_to session.delete(:return_to), :notice => 'Studio note was deleted.' }
      format.json { head :no_content }
    end
  end
end